...
listUser.forEach((elment) => {
    console.log("Firstname: ", elment.firstName, " - Lastname: ", elment.lastName);
});
// Bài 2:
const checkAge = (array, gender, age) => {
...
console.log("Tuổi trung bình của các user là: ", Math.ceil(advAge / users.length));
let sum = 0;
for (let i = 0; i < 10; i++) {
    sum += i;
}
